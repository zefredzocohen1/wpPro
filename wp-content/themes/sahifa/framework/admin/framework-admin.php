	...
	function tie_admin_register() {
		...
		if ( (isset( $_GET['page'] ) && $_GET['page'] == 'panel') || (  $pagenow == 'post-new.php' ) || (  $pagenow == 'post.php' )|| (  $pagenow == 'term.php' ) ) {
			...
			$tie_lang = array(
				...
				"shortcode_page"			=> __( 'Page', 'tie' ),
				'shortcode_button_ads'		=> __( 'Button ads', 'tie'),
				'shortcode_type_ads'		=> __( 'Type ads', 'tie'),
				'shortcode_button'			=> __( 'Button'),
				'shortcode_type_ads_no'		=> __( 'No type ads', 'tie'),
				'shortcode_type_ads_adf_ly'	=> __( 'Adf.ly', 'tie'),
				'shortcode_type_ads_ouo_io'	=> __( 'Uuo.io', 'tie'),
				'shortcode_type_ads_uskip'		=> __( 'Uskip', 'tie'),
				'shortcode_type_ads_shorte_st'	=> __( 'Shorte.st', 'tie'),
				...
				"shortcode_button2"			=> __( 'Button test', 'tie' ),
